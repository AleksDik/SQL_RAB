DROP VIEW KURS3.V_HOUSING_LIST;

CREATE OR REPLACE FORCE VIEW KURS3.V_HOUSING_LIST
(OKRUG_ID, NAME, ADDRESS, AFFAIR_ID, INSPECTOR, 
 TYPE, SQI, SQO_A, APARTMENT_NUM, CONDITION, 
 USER_ID, LIST_COD, LIST_NUM, NOTE, APART_ID, 
 READ_ONLY, STATUS_BTI, ROOMS_NUMBER, RES, INSTR_NUM, 
 INSTR_DATE, CERTIF_NUM, CERTIF_DATE, NEWB, STOREY, 
 LAST_CHANGE, STOREY_B, SQO, S_DELIVERY, S_CALCULATION, 
 FACTORY, FACTORY_COD, FUND, INPUT_DATE, INPUT_OKRUG, 
 ORDER_NUM, ORDER_SER, ORDER_DATE, STREET_NAME, BUILDING_NUM, 
 BUILDING_IDX, HOUSE_NUM, HOUSE_IDX, CONSTRUCTION_NUM, CONSTRUCTION_IDX, 
 P_SPACE, INSTRUCTION_DIR, INSTRUCTION_WHO, F12, F12_DATE, 
 MSK, MSK_DATE, ORDER_CREATION_DATE, P8, SGS, 
 SGS_DATE, SGS_DATE_TO, REAL_INSTR_NUM, REAL_INSTR_DATE, REAL_F4_WHO, 
 REAL_INSTR_DIR, REAL_TARGET, INSTR_TARGET, ADDRESS_SH, REAL_INSTR_S_DELIVERY, 
 REMAIND_YEAR, REASON, ORDER_DIRECTION, PR_FAKT, OTKL, 
 INSTR_YEAR, ORDER_YEAR, EXPL_SER, EXPL_ETAZH, EXPL_PL_COMMON, 
 EXLP_PL_LIVING, BALANCE_FACTORY, ZDG1, TOTAL_SPACE, LIVING_SPACE, 
 BP1, F12_FUND, F12_DELIV, F12_PNZ, EXLP_KV_COUNT, 
 OPD_KPI, CP_NUM, ZDZ, ADDR_S, INVALID_CARR, 
 B_MOKRUG, R1_NUM, R1_DATE, ORDER_CALC_DATE, ORDER_PERSON_MASTER, 
 TOTAL_SPACE_WO, ORDER_PRIORITET, ORDER_PLAN_TYPE, YEAR_REALIZ, D_PF, 
 OTKL_PF, BLD_TYPE, COTTAGE, UNOM, FUND_OWNER, 
 AP_ZAK, ORDER_RES_NUM, ORDER_RES_DATE, RF_IN_OKRUG, RF_IN_DEP, 
 OUT_F_NAME, OUT_F_P8, OUT_I_NUM, OUT_I_DATE, MGSN_NUM, 
 MGSN_DATE, ORDER_STAGE, FACTORY_OKRUG, FACTORY_STATUS, BTI_PPL, 
 BTI_OPL, BTI_GPL, BTI_SUMPL, AP_ID, PREFECT_NUM, 
 PREFECT_DATE, ZDZ_RP, ND_ZDZ_RP_CREATION_DATE, ND_ZDZ_RP_LAST_CHANGE, LAST_Z_ORDER_NUM, 
 LAST_Z_ORDER_SER, LAST_Z_ORDER_DATE, LAST_Z_ORDER_YEAR, LAST_Z_ORDER_S_CALC, F4LAST10_11N, 
 F4LAST10_11D, F4FIRST10_DEP_N, F4FIRST10_DEP_D, F4FIRST10_DEP_R, F4FIRST10_DEP_DIR, 
 F4FIRST10_DEP_TARG, EGRP_NUM, EGRP_DATE, EGRP_DATE_TO, EGRP_ARCH, 
 EGRP_DATE_ARCH, RF_FREESPACE, NEWB_NUM, NEWB_YEAR, R_ST_DOG, 
 R_DOG_NUM, R_DOG_DATE, R_REJECT_CAUSE, R_REG_DATE, LAST_ADDR_REC, 
 ORDER_PERSON_CNT, ORDER_ORDER_TYPE, ORDER_END_AFFAIR, ORDER_NEW_ADDR, ORDER_ADD_SQUARE, 
 AGREE_NUM, AGREE_DATE, AGREE_REG_NUM, AGREE_REG_DATE, AGREEDATE, 
 STATE_REG_DATE, STATE_REG_REQUIRED, SBS_FL, RSGS_FOND, RSGS_FOND_DATE_FROM, 
 RSGS_FOND_DATE_TO, RSGS_IS_SPEC_FOND, RSGS_FOND_OUT, SBS_TOTAL, NO_ADULT_CNT, 
 ORDER_AFFAIR_ADDR, ORDER_AFFAIR_KV, MANCOMP, BASIS, ADDENUM, 
 SELFTRAPPING, RUNPOPULATED_DATE, RUNPOPULATED_TXT, RUNPOPULATED_ID, RUNPOPULATED_NAME, TP_EXISTS)
AS 
SELECT                                                          /*- RULE */
          --
          ...
          SUBSTR (get_inspector (free_space.inspector, free_space.okrug_id),
                  1,
                  50), --RTRIM (TO_CHAR (free_space.rooms_number)) || ' ' ||  -- закомментил по просьбе Н.В. 21.06.2011
          ...
          SUBSTR (get_new_building_code_1 (free_space.new_building_code),
                  1,
                  49)
             newb, --DECODE(FREE_SPACE.NEW_BUILDING_CODE,0,' ',NULL,' ',building.BUILDING_YEAR||' - '||to_char(FREE_SPACE.NEW_BUILDING_CODE,'99999')) newb,
          apartment.room_storey_num storey, --to_char(free_space.LAST_CHANGE,'dd.mm.yyyy'),
          ...
          DECODE (free_space.doc_type,
                  ...
                  NULL)
             input_okrug,
          SUBSTR (get_order_num_2 (free_space.doc2_num, 'NN'), 1, 10)
             AS order_num,
          ...
          get_factory_p8 (free_space.department,
                          free_space.num_in_department)
             AS p8 --   , DECODE(mgr_l.registration_code, NULL, '-', 'Мос.') SGS
                  --   , mgr_l.registration_date sgs_date
          ,
          SUBSTR (get_apartment_rgs_1 (apartment.apart_id, 'APR_STATUS'),
                  1,
                  10)
             AS sgs --DECODE (INSTR (get_apartment_rgs_1 (apartment.apart_id, 'DATA'), 'по'),  NULL, '-',  0, 'Мос.',  '-') as sgs
                   ,
          TO_DATE (get_apartment_rgs_1 (apartment.apart_id, 'DATE_FROM'),
                   'dd.mm.yyyy')
             AS sgs_date,
          TO_DATE (get_apartment_rgs_1 (apartment.apart_id, 'DATE_TO'),
                   'dd.mm.yyyy')
             AS sgs_date_to,
          ...
          free_space.remaind_year AS remaind_year            --ka.balance_year
                                                 ,
          SUBSTR (
             DECODE (
                is_document_order (free_space.doc2_num, free_space.doc2_type),
          ...
          get_order_year_2 (doc2_num, doc2_type) AS order_year --,SUBSTR (get_classifier (29, xn.zser), 1, 80) AS expl_ser
                                                              ,
          SUBSTR (
             get_classifier (
                29,
          ...
          get_opd_kpi (free_space.apart_id, 3) AS opd_kpi --        ,SUBSTR (get_classifier_kurs3 (108, fcp1.cp_num, 'SN2'), 1, 100) AS cp_num
          ...
          SUBSTR (
             ...
             1,
             100)
             AS cp_num, --DECODE (NVL (free_space.new_building_code, 0), 0, 'Н.т.', DECODE (xn.zdz, NULL, 'Не уст.', TO_CHAR (xn.zdz, 'DD.MM.YYYY')))
          DECODE (
             NVL (free_space.new_building_code, 0),
             0, TO_DATE (NULL),
             TRUNC (
          ...
          DECODE (NVL (free_space.new_building_code, 0),
             ...
             AS otkl_pf,
          SUBSTR (get_classifier_h2 (50, building_type), 1, 15) AS bld_type --        ,SUBSTR (get_classifier_h3 (58, building.cottage), 1, 4) AS cottage
                                                                           ,
          ...
          SUBSTR (
             DECODE (
                is_document_order (free_space.doc2_num, free_space.doc2_type),
                1, DECODE (
                      get_order_stage (free_space.doc2_num),
                      0, '',
                      -1, '',
                      -2, '',
                      get_classifier_kurs3 (
                         115,
                         get_order_stage (free_space.doc2_num),
                         'SN1')),
                NULL),
          ...
          TO_CHAR (
             DECODE (
                free_space.space_type,
                1, bti.get_apart_pl (
                      get_bti_by_apart_unom (apartment.apart_id),
          ...
          xn.zpv AS newb_year -- get_new_building_code_year (free_space.new_building_code)
                             ,
          SUBSTR (
             DECODE (
                is_document_order (free_space.doc2_num, free_space.doc2_type),
                1, visa.rdn_rep.get_dog_param_by_order (free_space.doc2_num,
                                                        'STATUS'),
                NULL),
             1,
             40)
          ...
          DECODE (
             ...
             '')
             AS agree_reg_date --        ,DECODE (is_document_order (free_space.doc2_num, free_space.doc2_type), 1, get_order_dates (free_space.doc2_num, 'AGREEMENT_DATE'), '')
                              --           AS agreedate
          ...
          DECODE (
             ...
             1, DECODE (
                   ...
                   'М', TO_DATE (
                            DECODE (
                               is_document_order (free_space.doc2_num,
                                                  free_space.doc2_type),
                               1, visa.rdn_rep.get_dog_param_by_order (
                                     free_space.doc2_num,
                                     'REG_DATE'),
                               NULL),
                            'dd.mm.yyyy'),
                   ...
                   get_order_dates (free_space.doc2_num, 'AGREEMENT_DATE')),
             '')
             AS agreedate --        ,DECODE (is_document_order (free_space.doc2_num, free_space.doc2_type), 1, get_order_dates (free_space.doc2_num, 'STATE_REG_DATE'), '')
                         --           AS state_reg_date
                         /*        ,DECODE (is_document_order (free_space.doc2_num, free_space.doc2_type), 1,
                                         DECODE( trim(get_order_num_2 (free_space.doc2_num, 'SS')),
                                            'КПИ', TO_DATE (get_apartment_rgs_1 (apartment.apart_id, 'DATE_TO'),'dd.mm.yyyy'),
          ...
          DECODE (get_sbs_fl (apartment.apart_id), 1, 'да', NULL) AS SBS_FL -- собственность третьих лиц - Сбс_ФЛ
                                                                             ,
          ...
          get_rsgs_fond (apartment.unom_bti,
                         apartment.unkv_bti,
                         'IS_SPEC_FOND'),
          ...
          CASE get_sbs_total (apartment.apart_id, free_space.freespace_id)
             ...
             WHEN 2 THEN 'Сбс.'
             WHEN 3 THEN 'Кмн.'    
              WHEN 6  THEN 'Сбс/Мск' --17.12.2012 ilonis
             ELSE ''
          END
             AS sbs_total,
          DECODE (
          ...
          DECODE (
             ...
             AS ORDER_AFFAIR_KV                  -- № квартиры КПУ для выписки
                               ,
          get_management_company_name (NVL (building.management_company, 0))
             AS mancomp,
          (SELECT t.basis
             FROM INSTRUCTION t
          ...
          (SELECT name
            ...
            (decode( pkg_techpasport.get_techpasport_exists (APARTMENT.APART_ID ), 1 , 'Да' , 'Нет'))   as tp_exists   
     FROM apartment,
          free_space,
          building,
          housing_list,
    ...
    WHERE     housing_list.affair_id = free_space.freespace_id
          ...
          --     AND NVL (free_space.apart_id2, free_space.apart_id) = mgr_l.apart_id(+)   --    12.12.2005    Изменение для ПФ Bfink
          --     AND free_space.building_id = mgr_l.building_id(+)
          --     AND mgr_l.licence_date(+) IS NOT NULL
          --     AND mgr_l.cancel_date(+) IS NULL
...
DROP SYNONYM O58.V_HOUSING_LIST;

CREATE OR REPLACE SYNONYM O58.V_HOUSING_LIST FOR KURS3.V_HOUSING_LIST;


DROP SYNONYM O56.V_HOUSING_LIST;

CREATE OR REPLACE SYNONYM O56.V_HOUSING_LIST FOR KURS3.V_HOUSING_LIST;


DROP SYNONYM O52.V_HOUSING_LIST;

CREATE OR REPLACE SYNONYM O52.V_HOUSING_LIST FOR KURS3.V_HOUSING_LIST;


DROP SYNONYM O57.V_HOUSING_LIST;

CREATE OR REPLACE SYNONYM O57.V_HOUSING_LIST FOR KURS3.V_HOUSING_LIST;


DROP SYNONYM O55.V_HOUSING_LIST;

CREATE OR REPLACE SYNONYM O55.V_HOUSING_LIST FOR KURS3.V_HOUSING_LIST;


DROP SYNONYM O31.V_HOUSING_LIST;

CREATE OR REPLACE SYNONYM O31.V_HOUSING_LIST FOR KURS3.V_HOUSING_LIST;


DROP SYNONYM KURSIV.V_HOUSING_LIST;

CREATE OR REPLACE SYNONYM KURSIV.V_HOUSING_LIST FOR KURS3.V_HOUSING_LIST;


DROP SYNONYM O51.V_HOUSING_LIST;

CREATE OR REPLACE SYNONYM O51.V_HOUSING_LIST FOR KURS3.V_HOUSING_LIST;


DROP SYNONYM O54.V_HOUSING_LIST;

CREATE OR REPLACE SYNONYM O54.V_HOUSING_LIST FOR KURS3.V_HOUSING_LIST;


DROP SYNONYM O53.V_HOUSING_LIST;

CREATE OR REPLACE SYNONYM O53.V_HOUSING_LIST FOR KURS3.V_HOUSING_LIST;


DROP SYNONYM O60.V_HOUSING_LIST;

CREATE OR REPLACE SYNONYM O60.V_HOUSING_LIST FOR KURS3.V_HOUSING_LIST;


DROP SYNONYM K3_DISP_F12.V_HOUSING_LIST;

CREATE OR REPLACE SYNONYM K3_DISP_F12.V_HOUSING_LIST FOR KURS3.V_HOUSING_LIST;


DROP SYNONYM O59.V_HOUSING_LIST;

CREATE OR REPLACE SYNONYM O59.V_HOUSING_LIST FOR KURS3.V_HOUSING_LIST;


DROP SYNONYM O62.V_HOUSING_LIST;

CREATE OR REPLACE SYNONYM O62.V_HOUSING_LIST FOR KURS3.V_HOUSING_LIST;


DROP SYNONYM O63.V_HOUSING_LIST;

CREATE OR REPLACE SYNONYM O63.V_HOUSING_LIST FOR KURS3.V_HOUSING_LIST;


DROP SYNONYM O61.V_HOUSING_LIST;

CREATE OR REPLACE SYNONYM O61.V_HOUSING_LIST FOR KURS3.V_HOUSING_LIST;


DROP SYNONYM SUBSID.V_HOUSING_LIST;

CREATE OR REPLACE SYNONYM SUBSID.V_HOUSING_LIST FOR KURS3.V_HOUSING_LIST;


GRANT SELECT ON KURS3.V_HOUSING_LIST TO OKRUG;
