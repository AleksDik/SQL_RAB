...
SELECT                                                          /*- RULE */
          ...
          --#D22.08.2013 Dik зад. 1.96: Добавлены поля инф. о Переселении (RELOC_GROUP_NAME,RELOC_YESNO); В последней постановке 1.96 поле RELOC_PROGRAM_YEAR вычеркнуто! 
--
          building.area,
...
-- #D22.08.2013
          AND free_space.apart_id = RELOC.reloc_apart_id(+)
          AND free_space.building_id = RELOC.reloc_building_id(+);          
