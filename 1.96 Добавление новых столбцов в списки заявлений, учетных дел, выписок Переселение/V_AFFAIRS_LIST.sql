...
-- #D22.08.2013 / (Дикан) Добавлены поля инф. о Переселении (RELOC_GROUP_NAME,RELOC_YESNO) В последней постановке 1.96 поле RELOC_PROGRAM_YEAR вычеркнуто!
...
-- #D09.07.2013
         ...
         FN_GET_PDS_DATE(affair.affair_id) AS pds_date,                       --02.07.2013 onovikova задача 107
-- /#D09.07.2013
-- #D22.08.2013
         case when NVL(RELOC.reloc_apart_id,0) = 0 then NULL else  GET_relocation_program(RELOC.reloc_apart_id)
         end as RELOC_GROUP_NAME,
        -- RELOC.RELOC_PROGRAM_YEAR,
...
-- /#D20.06.2013
-- #D22.08.2013
          (SELECT reloc_apart_id , reloc_building_id--, reloc_program_year
           FROM v_relocation_from_emig
           group by reloc_apart_id , reloc_building_id--, reloc_program_year
           ) RELOC
 -- / #D22.08.2013
